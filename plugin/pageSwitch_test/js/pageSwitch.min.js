! function(t) {
    var e = function(t) {
        ...
        n = function() {
            function n(e, n) { this.settings = t.extend(!0, t.fn.PageSwitch.defaults, n || {}), this.element = e, this.init() }
            return n.prototype = {
                init: function() {
                    var t = this;
                ...
                _autoPlay: function() {
                    function t() { e.timer = setTimeout(function() { e.next(), t() }, e.settings.interval) }
                    var e = this;
                    t()
                },
                _stopPlay: function() { clearTimeout(this.timer) },
                ...
                _initEvent: function() {
                    var e = this;
                    e.element.on("mouseover", e.selectors.pages + " li", function() { e.index = t(this).index(), e._scrollPage() }), e.element.on("mouseover", e.selectors.pages + " li", function() { e._stopPlay() }), e.element.on("mouseout", e.selectors.pages + " li", function() { e._autoPlay() })
                },
                prev: function() {
                    var t = this;
                ...
                _scrollPage: function() {
                    ...
                    if (i) {
                        if (n.canScroll = !1, e) {
                            ...
                            n.sections.animate(o, n.settings.duration, function() { n.canScroll = !0, n.settings.callback && "function" === t.type(n.settings.callback) && n.settings.callback() })
                        }
    ...
    }, t.fn.PageSwitch.defaults = { selectors: { sections: ".sections", section: ".section", pages: ".pages", active: ".active" }, index: 0, easing: "ease", duration: 500, loop: !1, pagination: !0, keyboard: !0, direction: "vertical", autoPlay: !0, interval: 3e3, callback: "" }, t(function() { t("[data-PageSwitch]").PageSwitch() })
}(jQuery);
